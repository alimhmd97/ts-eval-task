    ...
    return (
      ...
      <div className="justify-center items-center flex flex-col px-16 max-md:max-w-full max-md:px-5">
        <span className="flex w-[860px] max-w-full flex-col">
          ...
          <span className="cursor-pointer text-light text-center text-sm font-semibold leading-4 tracking-tight whitespace-nowrap justify-center items-center border border-[color:var(--Brand-Colours-Red-200,#EC202C)] bg-danger self-stretch mt-8 px-16 py-5 rounded-[70px] border-solid max-md:max-w-full max-md:px-5">
            Take Full test
          </span>
          <div className="self-stretch flex items-stretch justify-between gap-2.5 mt-2.5 max-md:max-w-full max-md:flex-wrap">
            <span className="text-slate-800 cursor-pointer text-center text-sm font-semibold leading-4 tracking-tight whitespace-nowrap justify-center items-center border border-[color:var(--Brand-Colours-Navy-blue-200,#273249)] grow px-16 py-5 rounded-[70px] border-solid max-md:px-5">
              Booster: Expertise
            </span>
            <span className="text-slate-800 cursor-pointer text-center text-sm font-semibold leading-4 tracking-tight whitespace-nowrap justify-center items-center border border-[color:var(--Brand-Colours-Navy-blue-200,#273249)] grow px-16 py-5 rounded-[70px] border-solid max-md:px-5">
              Booster: Brand
          ...
          <span className="text-slate-800 cursor-pointer text-center text-sm font-semibold leading-4 tracking-tight whitespace-nowrap justify-center items-center border border-[color:var(--Brand-Colours-Navy-blue-200,#273249)] w-[280px] max-w-full mt-2.5 px-16 py-5 rounded-[70px] border-solid self-start max-md:px-5">
            Booster: Audience
          </span>
          <span  onClick={()=>{
              updateProgress()
            }} className="justify-center items-center border border-[color:var(--Brand-Colours-Red-200,#EC202C)] bg-danger flex gap-2.5 mt-14 px-6 py-3.5 rounded-[70px] border-solid self-end max-md:mt-10 max-md:px-5">
