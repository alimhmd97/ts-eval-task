...
const NextStepsCard = () => {
    return (
      ...
      <div className="bg-muted items-center bg-stone-50 self-stretch flex justify-between gap-2 mt-4 px-4 py-3 rounded-lg max-md:max-w-full max-md:flex-wrap">
        ...
        <div className=" cursor-pointer text-slate-800 text-center text-sm font-semibold leading-4 tracking-tight whitespace-nowrap justify-center items-stretch border border-[color:var(--Brand-Colours-Navy-blue-200,#273249)] self-stretch px-3 py-2.5 rounded-[70px] border-solid">
          View action plan
        </div>
      </div>
      ...
      <div className="bg-muted items-center bg-stone-50 self-stretch flex justify-between gap-2 mt-2 px-4 py-3 rounded-lg max-md:max-w-full max-md:flex-wrap">
        ...
        <div className="justify-between border border-[color:var(--Brand-Colours-Navy-blue-200,#273249)] self-stretch flex gap-2.5 px-3 py-2 rounded-[70px] border-solid items-start">
          <div className="cursor-pointer text-slate-800 text-center text-sm font-semibold leading-4 tracking-tight">
            Register
          </div>
          <img
          alt=''
      ...
      <div className="bg-muted cursor-pointer text-slate-800 text-center text-sm font-semibold leading-4 tracking-tight whitespace-nowrap justify-center items-stretch border border-[color:var(--Brand-Colours-Navy-blue-200,#273249)] mt-4 px-6 py-4 rounded-[70px] border-solid self-start max-md:px-5">
        View more
      </div>
    </div>
    );
